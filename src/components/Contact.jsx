export default function Contact() {
    return (
        <div className="bg-gray-900 text-white py-12">
            <div className="container mx-auto flex flex-col gap-4 md:flex-row justify-between items-start px-2 md:px-4">
                <div className="md:w-1/2 mb-8 md:mb-0">
                    ...
                    <div className="my-2">
                        <input
                            ...
                            type="email"
                            className="w-full my-1 py-1 px-3 focus:outline-none rounded bg-tertiary"
                        />{' '}
                        <br />
                        <input
                            placeholder="Write your message..."
                            className="w-full my-1 h-10 py-2 px-3 focus:outline-none rounded bg-tertiary"
                        />
                    </div>
