...
const projects = {
  web: [
    {
      title: "Gradienta",
      description: "A Collection of free Multicolor CSS, JPG, PNG, SVG Gradients with a Gradienta Editor",
    ...
    {
      title: "DevSonket",
      description: "A Collection of Bengali Cheatsheets for developers, completely open-source",
    ...
    {
      title: "js.zonayed.me",
      description: "Learn Practical use case of JavaScript in your everyday life, entirely in Bengali",
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects[activeTab].map((project, index) => (
              ...
              >
                {project.image && (
                  <Image src={project.image} alt={project.title} className="w-full h-48 object-cover" width={500} height={500} />
                )}
                <div className="p-6">
